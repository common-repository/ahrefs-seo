...
abstract class Base
{
    ...
    function __construct($mode = self::MODE_CBC)
    {
        ...
        if (!\defined('ahrefs\\AhrefsSeo_Vendor\\CRYPT_BASE_USE_REG_INTVAL')) {
            switch (\true) {
                ...
                case \PHP_INT_SIZE == 8:
                    \define('ahrefs\\AhrefsSeo_Vendor\\CRYPT_BASE_USE_REG_INTVAL', \true);
                    break;
                case (\php_uname('m') & "\xdf\xdf\xdf") == 'ARM':
                    switch (\true) {
                        ...
                        case \PHP_VERSION_ID >= 70200 && \PHP_VERSION_ID <= 70211:
                            \define('ahrefs\\AhrefsSeo_Vendor\\CRYPT_BASE_USE_REG_INTVAL', \false);
                            break;
                        default:
                            \define('ahrefs\\AhrefsSeo_Vendor\\CRYPT_BASE_USE_REG_INTVAL', \true);
                    }
    ...
    function setPassword($password, $method = 'pbkdf2')
    {
        ...
        switch ($method) {
            case 'bcrypt':
                ...
                $bf = new \ahrefs\AhrefsSeo_Vendor\phpseclib\Crypt\Blowfish();
            ...
            default:
                ...
                switch (\true) {
                    case $method == 'pbkdf1':
                        $hashObj = new \ahrefs\AhrefsSeo_Vendor\phpseclib\Crypt\Hash();
                    ...
                    case !\in_array($hash, \hash_algos()):
                        $i = 1;
                        $hmac = new \ahrefs\AhrefsSeo_Vendor\phpseclib\Crypt\Hash();
                        $hmac->setHash($hash);
