...
class Ahrefs_Seo_View {
	...
	private function register_scripts() {
		...
		wp_localize_script( self::AHREFS_JS_HANDLE, 'ahrefs_seo_strings', [ 'enter_auth_code' => esc_html__( 'Please enter your authorization code', 'ahrefs-seo' ) ] );
	 ...
	 * @since 0.10.1
	 */
	public function learn_more_link( $href, $text ) {
		?>
